...
[BotCommand("add_member", "Назначить данный состав телеграм чата в качестве команды.", Models.CommandAvailabilityScope.Chat | Models.CommandAvailabilityScope.Private)]
internal class AddMemberCommand : IBotCommand
{
